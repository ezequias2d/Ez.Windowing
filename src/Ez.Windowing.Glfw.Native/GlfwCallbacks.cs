...
namespace Ez.Windowing.GLFW.Native
{
    ...
    public static class GlfwCallbacks
    {
        ...
        public delegate void CharModsCallback(Window window, uint codepoint, Enums.KeyModifiers modifiers);
        ...
        public delegate void DropCallback(
            Window window, 
            int count, 
            [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPUTF8Str, SizeParamIndex = 1)][In] string[] paths);
        ...
        public delegate void KeyCallback(Window window, Enums.Keys key, int scanCode, InputAction action, Enums.KeyModifiers mods);
        ...
        public delegate void MouseButtonCallback(Window window, Enums.MouseButton button, InputAction action, Enums.KeyModifiers mods); // TODO: Make enums for int params in callback
